...
class ExitAndUpdateDialog extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      ...
      content: Container(
        height:!AppReference.isPortrait(context)? AppReference.deviceHeight(context)*0.65:null,
        ...
        constraints: BoxConstraints(
          ...
          maxHeight: AppReference.deviceHeight(context) * 0.34.responsiveHeightRatio,
        ),
