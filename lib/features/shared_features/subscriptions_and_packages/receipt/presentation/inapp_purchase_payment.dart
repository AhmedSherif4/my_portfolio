...
// import '../../../../child_flow/more/presentation/more_widgets/header_for_more.dart';
// import '../../cart/domain/auth_entity/cart_entity.dart';
// import '../../payment_successfully/presentation/view_model/pay_success_bloc.dart';
//
//
...
//   InAppPurchasePayment(this.classroomForCart);
//   @override
...
//     _connection.getPlatformAddition<InAppPurchaseStoreKitPlatformAddition>();
...
//                                                 child: FittedBox(
//                                                     fit: BoxFit.scaleDown,
//                                                     child: Text("الدفع غير متاح لهذا التطبيق تواصل مع الدعم"
//                                                     )
//                                                 )
//                                             ),
//                                           ]
...
//                                                 alignment: Alignment.center,
//                                                 child: Text(_products[0].description,
//                                                   style: AppTextStyle.bodyMedium14,
//                                                 )
//                                             ),
//                                             Container(
...
//                                                 child: FittedBox(
//                                                     fit: BoxFit.scaleDown,
//                                                     child: Text("عليك دفع مبلغ  "+_products[0].price+" لفتح المحتوي",
//                                                       style: AppTextStyle.bodyMedium14,
//                                                     )
//                                                 )
//                                             ),
...
//                                                       child: FittedBox(
//                                                         child: Text("شراء ",
//                                                           style: AppTextStyle().bodyMedium14.copyWith(color: AppColors.white),
...
//               cartData: CartEntity(classrooms: [widget.classroomForCart], terms: [], subjects: [], totalPrice: 216),
//               totalPrice: 0,
//               coupon: '',
//               couponDiscount: '',
//               payStatus: false,
