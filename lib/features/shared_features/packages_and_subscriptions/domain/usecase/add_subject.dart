...
@LazySingleton()
class AddSubjectUseCase extends BaseUseCase<AddAndDeleteSubjectEntity, AddAndDeleteSubjectInputs>{
  ...
  Future<Either<Failure, AddAndDeleteSubjectEntity>> call(AddAndDeleteSubjectInputs parameter) async {
    return await _repository.addSubject(addAndDeleteSubjectInputs: parameter);
  }
}