...
import '../../child_flow/questions/lessons/presentation/lessons_widgets/lesson_builder.dart';
import '../../child_flow/questions/lessons/presentation/lessons_widgets/lesson_item.dart';
...
part 'domain/entity/nafees_plans_entity.dart';
part 'domain/repository/repository.dart';
part 'domain/usecase/get_nafees_plans_usecase.dart';
part 'data/model/nafees_plans_model.dart';
part 'data/repository/nafees_plans_repository.dart';
part 'data/remote/nafees_plans_remote_data_source.dart';
part 'presentation/view/nafees_plans_lesson_screen.dart';
part 'presentation/view/nafees_plans_screen.dart';
part 'presentation/view/nafees_plans_statics_screen.dart';
part 'presentation/view/nafees_plans_subject_screen.dart';
part 'presentation/view/nafees_model_answer_screen.dart';
part 'presentation/view/nafees_exams_screen.dart';
part 'presentation/view/nafees_exams_question_screen.dart';
part 'presentation/view_model/nafees_plans_bloc.dart';
part 'presentation/view_model/nafees_plans_event.dart';
part 'presentation/view_model/nafees_plans_state.dart';
